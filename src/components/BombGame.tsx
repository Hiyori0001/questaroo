  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleCloseDialog}>
      <DialogContent className={cn(
        "fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 sm:max-w-md bg-white dark:bg-gray-800 text-center p-6 relative overflow-hidden z-50 max-h-[calc(100vh-4rem)] overflow-y-auto",

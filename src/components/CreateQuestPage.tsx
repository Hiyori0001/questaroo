...
const CreateQuestPage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    if (selectedReferenceFile) {
      ...
      console.log("Creator Reference Image URL after upload:", creatorReferenceImageUrl); // Log here
    }

    console.log("Creator Reference Image URL before addQuest:", creatorReferenceImageUrl); // Log here
    const newQuest: Quest = {
      // No need to generate ID here, it will be generated by Supabase
      title: values.title,
      ...
      is_predefined: false, // Explicitly mark as not predefined
    };

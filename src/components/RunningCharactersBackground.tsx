...
import { Rabbit, Squirrel, Fox, Bird } from "lucide-react";
...
const RunningCharactersBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <Character icon={Fox} top="50%" animationDuration="20s" animationDelay="10s" direction="left-to-right" size="h-12 w-12" color="text-red-500 dark:text-red-400" />
